    ...
    <table border="1" cellspacing="0">
        ...
        <tbody>
            <tr>
                ...
                <td><a class="cekbtn" href="http://nizarhome.rf.gd/statistic.php"><i class="fas fa-server"></i></a></td>
            </tr>
            <tr>
                <td>arsip-nizarhome.rf.gd</td>
                <td><a class="cekbtn" href="http://arsip-nizarhome.rf.gd/statistic.php"><i class="fas fa-server"></i></a></td>
            </tr>
            <tr>
                <td>weta.epizy.com</td>
                <td><a class="cekbtn" href="http://weta.epizy.com/statistic.php"><i class="fas fa-server"></i></a></td>
            </tr>
            <tr>
                <td>nhome.rf.gd</td>
                <td><a class="cekbtn" href="http://nhome.rf.gd/statistic.php"><i class="fas fa-server"></i></a></td>
            </tr>
            <tr>
                <td>pcfr.rf.gd</td>
                <td><a class="cekbtn" href="http://pcfr.rf.gd/statistic.php"><i class="fas fa-server"></i></a></td>
            </tr>
